    ...
    <div class="p-4 pt-20 pl-60" >
        <main class="flex-1">
            <div class="rounded-3xl p-8 mb-8 shadow-xl bg-white">
                ...
                <div class="flex justify-end gap-2 mt-4">
                    <button onclick="_downloadMutuReport('excel')" 
                            class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700">
                        <i class="fas fa-file-excel mr-2"></i> Export Excel
                    </button>
                    <button onclick="_downloadMutuReport('pdf')"
        ...
        <div class="data-forms" style="display: none;">
            ...
            <div class="form-card overflow-x-auto" id="kritis-form" style="display: none;">
                <div class="form-title-header">
                    <h3><i class="fas fa-ambulance"></i> Waktu Lapor Hasil Tes Kritis Laboratorium</h3>
                    <div class="progress-bar-container">
                        <div class="progress-bar">
                            <div class="progress-bar-inner"></div>
                        </div>
            ...
            <div class="form-card overflow-x-auto" id="fornas-form" style="display: none;">
                <div class="form-title-header">
                    <h3><i class="fas fa-prescription-bottle-alt"></i> Kepatuhan Penggunaan Formularium Nasional (FORNAS)</h3>
                    <div class="progress-bar-container">
                        <div class="progress-bar">
                            <div class="progress-bar-inner"></div>
                        </div>
            ...
            <div class="form-card overflow-x-auto" id="visite-form" style="display: none;">
                <div class="form-title-header">
                    <h3><i class="fas fa-stethoscope"></i> Kepatuhan Waktu Visite Dokter</h3>
                    <div class="progress-bar-container">
                        <div class="progress-bar">
                            <div class="progress-bar-inner"></div>
                        </div>
