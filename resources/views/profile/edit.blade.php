...
<body class="min-h-full bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100">
    ...
    <div class="container mx-auto pt-20 px-4 sm:pl-64 sm:pr-5 animate-fadeIn">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 md:mb-8 gap-4">
            ...
            <div class="flex flex-wrap gap-2 w-full md:w-auto">
                <label for="modal-toggle" class="cursor-pointer bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 md:px-4 md:py-2 rounded-lg shadow-md transition-all duration-200 text-sm md:text-base w-full md:w-auto text-center">
    ...
    <div class="fixed inset-0 bg-gray-600/50 hidden peer2-checked:block z-50"></div>
    <div class="fixed inset-0 flex items-center justify-center hidden peer2-checked:flex z-50 p-4">
    ...
    <div class="fixed inset-0 bg-gray-600/50 hidden peer3-checked:block z-50"></div>
    <div class="fixed inset-0 flex items-center justify-center hidden peer3-checked:flex z-50 p-4">
