...
<nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 text-base">
  <div class="px-3 py-3 lg:px-5 lg:pl-3">
    <div class="grid grid-cols-12 items-center">
      <!-- Bagian kiri - Logo dan Toggle (3 kolom) -->
      <div class="col-span-3 flex items-center justify-start rtl:justify-end">
      ...
      <!-- Bagian tengah - Menu (6 kolom) -->
      <div class="col-span-6 hidden md:flex justify-center space-x-4 text-sm">
      ...
      <!-- Bagian kanan - Tanggal dan Profil (3 kolom) -->
      <div class="col-span-3 flex items-center justify-end gap-2 md:gap-3">
        <!-- Tanggal Realtime -->
        <div class="hidden sm:block text-xs md:text-sm text-gray-600 font-medium whitespace-nowrap">
        ...
        <div class="relative ml-2 md:ml-0">
          ...
          <!-- Dropdown Menu -->
          <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow absolute right-0" id="dropdown-user">
...
@media (max-width: 767px) {
  ...
  #logo-sidebar:not(.translate-x-0) + .sidebar-overlay {
    display: none;
  }
  
  #logo-sidebar.translate-x-0 + .sidebar-overlay {
    display: block;
    position: fixed;
    top: 0;
    left: 0;
...
/* Perbaikan spacing untuk bagian kanan */
...
/* Padding untuk navbar lebih compact */
nav {
  padding-left: 0.5rem;
  padding-right: 0.5rem;
}

/* Responsive text untuk tanggal */
