...
<body class="min-h-full bg-gradient-to-br from-slate-50 to-blue-50">
    ...
    <div class="p-4 pt-20 pl-60 pr-5 animate-fadeIn">
        <div class="p-6 border border-gray-200 rounded-xl shadow-lg bg-white/80 backdrop-blur-sm dark:border-gray-700 dark:bg-gray-800/80">
            ...
            <div class="mb-6 text-center justify-center space-x-4">
                    ...
                    <div class="p-6 cursor-pointer" onclick="toggleSection('alat-kesehatan')">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <i class="fas fa-chevron-down text-gray-400 transform transition-transform duration-300" id="arrow-alat-kesehatan"></i>
                            </div>
                        </div>
                    </div>
                    <div id="alat-kesehatan" class="hidden border-t border-gray-100">
                        <!-- Konten alat kesehatan akan diisi secara dinamis -->
                    </div>
                </div>
                    ...
                    <div class="p-6 cursor-pointer" onclick="toggleSection('linen')">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <i class="fas fa-chevron-down text-gray-400 transform transition-transform duration-300" id="arrow-linen"></i>
                            </div>
                        </div>
                    </div>
                    <div id="linen" class="hidden border-t border-gray-100">
                        <!-- Konten linen akan diisi secara dinamis -->
                    </div>
                </div>
        ...
        <div class="bg-white rounded-2xl p-8 max-w-2xl w-full mx-4 shadow-2xl transform transition-all duration-300 overflow-y-auto" style="max-height: 90vh;">
            ...
            <form action="{{ route('logistics.store') }}" method="POST" class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Unit/Bagian*</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Nama Barang/Alat*</label>
                            <input type="text" name="item_name" class="w-full p-3 border border-gray-300 rounded-lg text-gray-800 bg-white focus:ring-2 focus:ring-gray-800 focus:border-transparent" placeholder="Contoh: Tensimeter Digital" required>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="number" name="stock" min="0" class="w-full p-3 border border-gray-300 rounded-lg text-gray-800 bg-white focus:ring-2 focus:ring-gray-800 focus:border-transparent" placeholder="0" required>
                        </div>
                ...
                <div>
                    ...
                    <textarea name="notes" rows="2" class="w-full p-3 border border-gray-300 rounded-lg text-gray-800 bg-white focus:ring-2 focus:ring-gray-800 focus:border-transparent" placeholder="Catatan tambahan..."></textarea>
                </div>
