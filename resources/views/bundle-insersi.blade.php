        ...
        <div class="p-4 border-2 border-gray-200 border-dashed flex flex-col gap-8 rounded-lg dark:border-gray-700 mt-14">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Bundle Insersi RSUP Adam Malik</span>
                </div>
                </li>
            </ol>
            </nav>
            <div class="font-medium dark:text-white text-black text-3xl">Bundle Insersi RSUP Adam Malik</div>
            <main class="p-4 h-auto">
                <div class="grid grid-cols-2 sm:grid-cols-1 gap-8 mb-4">
                    <div class=" rounded-lg gap-3 flex flex-col">
                        <div class="text-bold dark:text-white text-gray-700 text-xl ">Melakukan kebersihan tangan (5 Moment)</div>
                    ...
                    <div class=" rounded-lg gap-3 flex flex-col">
                        <div class="text-bold dark:text-white text-gray-700 text-xl ">Melakukan pemasangan CVC yang dilakukan di ruangan tindakan</div>
                        <div class="grid grid-cols-2 gap-4 w-full">
                            <div class="flex items-center w-full ps-4 border border-gray-200 rounded-md dark:border-gray-700">
