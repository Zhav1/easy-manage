...
<body>
    <div class="header">
        ...
        <p>Minggu: {{ $start_date }} - {{ $end_date }}</p>
    ...
    <h2 class="section-title">Jadwal Dinas Staff</h2>
    <table>
        <thead>
            <tr>
                <th>Nama Staff</th>
        ...
        <tbody>
            @forelse($schedules as $staffRow)
                <tr>
                    <td>{{ $staffRow['staff_name'] }}</td>
                    <td>{{ $staffRow['senin'] }}</td>
                    <td>{{ $staffRow['selasa'] }}</td>
                    <td>{{ $staffRow['rabu'] }}</td>
                    <td>{{ $staffRow['kamis'] }}</td>
                    <td>{{ $staffRow['jumat'] }}</td>
                    <td>{{ $staffRow['sabtu'] }}</td>
                    <td>{{ $staffRow['minggu'] }}</td>
                </tr>
            @empty
                <tr>
                    <td colspan="8" style="text-align: center;">Tidak ada jadwal dinas untuk staff Anda minggu ini.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
